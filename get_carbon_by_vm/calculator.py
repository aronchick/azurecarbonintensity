...
from get_carbon_by_vm.webservices import co2_per_watt_by_time_and_region
...
def calculate_co2(vm_type, datacenter_region,  number_of_cores, evaluation_time=datetime.datetime.now()):
    ...
    current_co2_load = co2_per_watt_by_time_and_region(datacenter_region, evaluation_time)
